...
You can get Android 16 QPR3 in any of the following ways:

* [Get QPR3 on a Google Pixel device](#on_pixel)
* [Get a generic system image (GSI)](#on_gsi)

## Get QPR3 on a Google Pixel device

The easiest way to get Android 16 QPR3 on a Pixel device is to [enroll your
...
Android 16 QPR3 is available for the following Pixel devices:
...
Tool](https://flash.android.com/preview/baklava-qpr3-beta2.1).
...
ready to download a GSI binary, see the [Downloads section](/about/versions/16/qpr3/gsi-release-notes#downloads) on the GSI
binaries page.